...
public sealed class SystemTerminalBackend : ITerminalBackend
{
    ...
    {
        return _inner.ReadEvents(cancellationToken);
    }
    ...
    {
        return TerminalInputParser.TryParseKittyKeySequence(buffer, ref offset, length, out terminalEvent);
    }
    ...
    {
        return TerminalInputParser.ResolveText(keyCode, modifiers, shiftedKey, textAsCodepoints);
    }
}
