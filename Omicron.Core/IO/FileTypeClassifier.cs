...
public static class FileTypeClassifier
{
    ...
    public static DetectedFileType Classify(string path, ReadOnlySpan<byte> bytes)
    {
        ...
        DetectedFileType? extResult = ClassifyByExtension(extension);
    ...
    private static DetectedFileType? ClassifyByExtension(string ext)
    {
        return ext switch
        {
            ...
            ".png"
                ...
                or ".ico"
                or ".tiff"
                or ".tif" => DetectedFileType.Image,

            // Audio
            ".mp3" or ".wav" or ".flac" or ".ogg" or ".aac" or ".m4a" or ".wma" or ".opus" =>
                DetectedFileType.Audio,

            // Video
            ".mp4" or ".avi" or ".mov" or ".webm" or ".mkv" or ".wmv" or ".flv" =>
            ...
            ".zip" or ".tar" or ".gz" or ".tgz" or ".bz2" or ".xz" or ".7z" or ".rar" =>
