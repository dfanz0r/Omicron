...
internal readonly struct Utf8PlaceholderInfo
{
    ...
    public ReadOnlySpan<byte> GetFormatSpec(ReadOnlySpan<byte> template) =>
        HasFormat ? template.Slice(SpecStart, SpecLength) : default;
}
...
public static partial class Utf8CompositeFormat
{
        ...
        where T1 : IUtf8SpanFormattable
    {
        written = 0;
        int offset = 0;
        return TryFormatCore(format, destination, ref written, ref offset, arg1) == Utf8FormatResult.Success;
    }
        ...
        where T2 : IUtf8SpanFormattable
    {
        written = 0;
        int offset = 0;
        return TryFormatCore(format, destination, ref written, ref offset, arg1, arg2) == Utf8FormatResult.Success;
    }
        ...
        where T3 : IUtf8SpanFormattable
    {
        written = 0;
        int offset = 0;
        return TryFormatCore(format, destination, ref written, ref offset, arg1, arg2, arg3) == Utf8FormatResult.Success;
    }
        ...
        where T4 : IUtf8SpanFormattable
    {
        written = 0;
        int offset = 0;
        return TryFormatCore(format, destination, ref written, ref offset, arg1, arg2, arg3, arg4) == Utf8FormatResult.Success;
    }
        ...
        T1 arg1)
    {
        written = 0;
        int offset = 0;
        return TryFormatSlowCore(format, destination, ref written, ref offset, arg1) == Utf8FormatResult.Success;
    }
        ...
        T1 arg1, T2 arg2)
    {
        written = 0;
        int offset = 0;
        return TryFormatSlowCore(format, destination, ref written, ref offset, arg1, arg2) == Utf8FormatResult.Success;
    }
        ...
        T1 arg1, T2 arg2, T3 arg3)
    {
        written = 0;
        int offset = 0;
        return TryFormatSlowCore(format, destination, ref written, ref offset, arg1, arg2, arg3) == Utf8FormatResult.Success;
    }
        ...
        T1 arg1, T2 arg2, T3 arg3, T4 arg4)
    {
        written = 0;
        int offset = 0;
        return TryFormatSlowCore(format, destination, ref written, ref offset, arg1, arg2, arg3, arg4) == Utf8FormatResult.Success;
    }
    ...
    public static PreparedUtf8CompositeFormat<T1> Prepare<T1>(ReadOnlySpan<byte> format)
        where T1 : IUtf8SpanFormattable
        => new PreparedUtf8CompositeFormat<T1>(format);
    ...
    public static PreparedUtf8CompositeFormat<T1, T2> Prepare<T1, T2>(ReadOnlySpan<byte> format)
        where T1 : IUtf8SpanFormattable
        where T2 : IUtf8SpanFormattable
        => new PreparedUtf8CompositeFormat<T1, T2>(format);
    ...
    public static PreparedUtf8CompositeFormat<T1, T2, T3> Prepare<T1, T2, T3>(ReadOnlySpan<byte> format)
        ...
        where T2 : IUtf8SpanFormattable
        where T3 : IUtf8SpanFormattable
        => new PreparedUtf8CompositeFormat<T1, T2, T3>(format);
    ...
    public static PreparedUtf8CompositeFormat<T1, T2, T3, T4> Prepare<T1, T2, T3, T4>(ReadOnlySpan<byte> format)
        ...
        where T3 : IUtf8SpanFormattable
        where T4 : IUtf8SpanFormattable
        => new PreparedUtf8CompositeFormat<T1, T2, T3, T4>(format);
    ...
    private static Utf8FormatResult TryFormatCore<T1>(
        ...
        T1 arg1) where T1 : IUtf8SpanFormattable
    {
        while (offset < format.Length)
        {
            ...
            if (b == (byte)'{')
            {
                ...
                {
                    if (!TryCopyByte((byte)'{', destination, ref written)) return Utf8FormatResult.InsufficientSpace;
                    offset += 2;
                    continue;
                }
                ...
                switch (info.Index)
                {
                    case 0: if (!TryFormatAligned(arg1, destination, ref written, info.GetFormatSpec(format), info.Alignment)) return Utf8FormatResult.InsufficientSpace; break;
            ...
            {
                if (!TryCopyByte(b, destination, ref written)) return Utf8FormatResult.InsufficientSpace;
                offset++;
            }
        }
        ...
        where T2 : IUtf8SpanFormattable
    {
        while (offset < format.Length)
        {
            ...
            if (b == (byte)'{')
            {
                ...
                {
                    case 0: if (!TryFormatAligned(arg1, destination, ref written, info.GetFormatSpec(format), info.Alignment)) return Utf8FormatResult.InsufficientSpace; break;
                    case 1: if (!TryFormatAligned(arg2, destination, ref written, info.GetFormatSpec(format), info.Alignment)) return Utf8FormatResult.InsufficientSpace; break;
                    default: ThrowIndexOutOfRange(info.Index); break;
                }
            }
            else if (b == (byte)'}')
        ...
        while (offset < format.Length)
        {
            ...
            if (b == (byte)'{')
            {
                ...
                switch (info.Index)
                {
                    case 0: if (!TryFormatAligned(arg1, destination, ref written, info.GetFormatSpec(format), info.Alignment)) return Utf8FormatResult.InsufficientSpace; break;
                    case 1: if (!TryFormatAligned(arg2, destination, ref written, info.GetFormatSpec(format), info.Alignment)) return Utf8FormatResult.InsufficientSpace; break;
                    case 2: if (!TryFormatAligned(arg3, destination, ref written, info.GetFormatSpec(format), info.Alignment)) return Utf8FormatResult.InsufficientSpace; break;
                    default: ThrowIndexOutOfRange(info.Index); break;
                }
            }
            else if (b == (byte)'}')
        ...
        while (offset < format.Length)
        {
            ...
            if (b == (byte)'{')
            {
                ...
                switch (info.Index)
                {
                    ...
                    case 1: if (!TryFormatAligned(arg2, destination, ref written, info.GetFormatSpec(format), info.Alignment)) return Utf8FormatResult.InsufficientSpace; break;
                    case 2: if (!TryFormatAligned(arg3, destination, ref written, info.GetFormatSpec(format), info.Alignment)) return Utf8FormatResult.InsufficientSpace; break;
                    case 3: if (!TryFormatAligned(arg4, destination, ref written, info.GetFormatSpec(format), info.Alignment)) return Utf8FormatResult.InsufficientSpace; break;
                    default: ThrowIndexOutOfRange(info.Index); break;
                }
            }
            else if (b == (byte)'}')
    ...
    /// </summary>
    private static Utf8PlaceholderInfo ParsePlaceholder(ReadOnlySpan<byte> format, scoped ref int offset)
    {
        offset++; // skip {
        int index = 0;
        bool hasDigit = false;
    ...
    internal static bool TryFormatUtf8<T>(T value, Span<byte> destination, ref int written, ReadOnlySpan<byte> formatSpec = default)
        where T : IUtf8SpanFormattable
    {
        if (formatSpec.IsEmpty)
        {
            if (!value.TryFormat(destination.Slice(written), out var n, default, null)) return false;
            written += n;
            return true;
        }
    ...
    internal static bool TryFormatAligned<T>(T value, Span<byte> destination, ref int written,
        ReadOnlySpan<byte> formatSpec, int alignment)
        where T : IUtf8SpanFormattable
    {
        int before = written;
    ...
    public static void Format<TBufferWriter, T1>(ref TBufferWriter writer, ReadOnlySpan<byte> format, T1 arg1)
        ...
        where T1 : IUtf8SpanFormattable
    {
        ...
        while (true)
        {
            ...
            var result = TryFormatCore(format, span, ref written, ref offset, arg1);
            ...
            if (capacity >= maxCap) ThrowInsufficientSpace();
            capacity = Math.Min(capacity * 2, maxCap);
        }
    }

    /// <summary>Format two args into an IBufferWriter<byte>.</summary>
    public static void Format<TBufferWriter, T1, T2>(ref TBufferWriter writer, ReadOnlySpan<byte> format, T1 arg1, T2 arg2)
        where TBufferWriter : IBufferWriter<byte>
        where T1 : IUtf8SpanFormattable
        where T2 : IUtf8SpanFormattable
    {
        ...
        while (true)
        {
            int written = 0, offset = 0;
            Span<byte> span = writer.GetSpan(capacity);
            var result = TryFormatCore(format, span, ref written, ref offset, arg1, arg2);
            if (result == Utf8FormatResult.Success)
            {
                writer.Advance(written);
                return;
    ...
    public static void Format<TBufferWriter, T1, T2, T3>(ref TBufferWriter writer, ReadOnlySpan<byte> format, T1 arg1, T2 arg2, T3 arg3)
        where TBufferWriter : IBufferWriter<byte>
        where T1 : IUtf8SpanFormattable
        where T2 : IUtf8SpanFormattable
        where T3 : IUtf8SpanFormattable
    {
        ...
        while (true)
        {
            int written = 0, offset = 0;
            Span<byte> span = writer.GetSpan(capacity);
            var result = TryFormatCore(format, span, ref written, ref offset, arg1, arg2, arg3);
            if (result == Utf8FormatResult.Success)
            {
                writer.Advance(written);
                return;
    ...
    public static void Format<TBufferWriter, T1, T2, T3, T4>(ref TBufferWriter writer, ReadOnlySpan<byte> format, T1 arg1, T2 arg2, T3 arg3, T4 arg4)
        where TBufferWriter : IBufferWriter<byte>
        where T1 : IUtf8SpanFormattable
        where T2 : IUtf8SpanFormattable
        where T3 : IUtf8SpanFormattable
        where T4 : IUtf8SpanFormattable
    {
        ...
        while (true)
        {
            int written = 0, offset = 0;
            Span<byte> span = writer.GetSpan(capacity);
            var result = TryFormatCore(format, span, ref written, ref offset, arg1, arg2, arg3, arg4);
            if (result == Utf8FormatResult.Success)
            {
                writer.Advance(written);
                return;
    ...
    public static void FormatSlow<TBufferWriter, T1>(ref TBufferWriter writer, ReadOnlySpan<byte> format, T1 arg1)
        where TBufferWriter : IBufferWriter<byte>
    {
        int capacity = Math.Max(format.Length + 256, 256);
        const int maxCap = 1024 * 1024 * 100;
        while (true)
        {
            int written = 0, offset = 0;
            Span<byte> span = writer.GetSpan(capacity);
            var result = TryFormatSlowCore(format, span, ref written, ref offset, arg1);
            if (result == Utf8FormatResult.Success)
            {
                writer.Advance(written);
                return;
    ...
    public static void FormatSlow<TBufferWriter, T1, T2>(ref TBufferWriter writer, ReadOnlySpan<byte> format, T1 arg1, T2 arg2)
        where TBufferWriter : IBufferWriter<byte>
    {
        int capacity = Math.Max(format.Length + 256, 256);
        const int maxCap = 1024 * 1024 * 100;
        while (true)
        {
            int written = 0, offset = 0;
            Span<byte> span = writer.GetSpan(capacity);
            var result = TryFormatSlowCore(format, span, ref written, ref offset, arg1, arg2);
            if (result == Utf8FormatResult.Success)
            {
                writer.Advance(written);
                return;
    ...
    public static void FormatSlow<TBufferWriter, T1, T2, T3>(ref TBufferWriter writer, ReadOnlySpan<byte> format, T1 arg1, T2 arg2, T3 arg3)
        where TBufferWriter : IBufferWriter<byte>
    {
        int capacity = Math.Max(format.Length + 256, 256);
        const int maxCap = 1024 * 1024 * 100;
        while (true)
        {
            int written = 0, offset = 0;
            Span<byte> span = writer.GetSpan(capacity);
            var result = TryFormatSlowCore(format, span, ref written, ref offset, arg1, arg2, arg3);
            if (result == Utf8FormatResult.Success)
            {
                writer.Advance(written);
                return;
    ...
    public static void FormatSlow<TBufferWriter, T1, T2, T3, T4>(ref TBufferWriter writer, ReadOnlySpan<byte> format, T1 arg1, T2 arg2, T3 arg3, T4 arg4)
        where TBufferWriter : IBufferWriter<byte>
    {
        int capacity = Math.Max(format.Length + 256, 256);
        const int maxCap = 1024 * 1024 * 100;
        while (true)
        {
            int written = 0, offset = 0;
            Span<byte> span = writer.GetSpan(capacity);
            var result = TryFormatSlowCore(format, span, ref written, ref offset, arg1, arg2, arg3, arg4);
            if (result == Utf8FormatResult.Success)
            {
                writer.Advance(written);
                return;
