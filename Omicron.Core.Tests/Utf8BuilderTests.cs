...
public class Utf8BuilderTests
{
    ...
    {
        using Utf8Builder builder = Utf8Text.CreateBuilder();
        Assert.Equal(0, builder.Length);
        Assert.False(builder.IsDisposed);
    }
    ...
    public void AsSpan_ReturnsWrittenData()
    {
        using Utf8Builder builder = Utf8Text.CreateBuilder();
        builder.Append("Hello");
        ReadOnlySpan<byte> span = builder.AsSpan();
    ...
    public void AsMemory_ReturnsWrittenData()
    {
        using Utf8Builder builder = Utf8Text.CreateBuilder();
        builder.Append("Hello");
        ReadOnlyMemory<byte> mem = builder.AsMemory();
    ...
    public void AsArraySegment_ReturnsWrittenData()
    {
        using Utf8Builder builder = Utf8Text.CreateBuilder();
        builder.Append("Hello");
        ArraySegment<byte> seg = builder.AsArraySegment();
    ...
    {
        using Utf8Builder builder = Utf8Text.CreateBuilder();
        Span<byte> span1 = builder.GetSpan(5);
        "Hello"u8.CopyTo(span1);
        builder.Advance(5);

        Span<byte> span2 = builder.GetSpan(5);
    ...
    public void TryCopyTo_SufficientSpace_Succeeds()
    {
        ...
        Assert.True(builder.TryCopyTo(dest, out int written));
    ...
    public void TryCopyTo_InsufficientSpace_Fails()
    {
        ...
        Assert.False(builder.TryCopyTo(dest, out int written));
    ...
    private readonly struct LargeFormattable : IUtf8SpanFormattable
    {
        ...
        public LargeFormattable(int size)
        {
            _size = size;
        }
