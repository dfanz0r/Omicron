...
public sealed class DividerWidget : ITuiWidget
{
    ...
    public void Arrange(Rect bounds) => _bounds = bounds;
    ...
    public void Render(RenderContext context)
    {
        ...
        if (!UseGradient)
        {
            var line = new string(DividerChar, width);
        ...
        var dividerUtf8 = Encoding.UTF8.GetBytes(DividerChar.ToString());
        GlyphRef dividerGlyph = dividerUtf8.Length == 1 && dividerUtf8[0] < 0x80
        ...
        for (int col = 0; col < width; col++)
        {
            ...
            var (r, g, b) = GradientHelper.Sample(gradientStops, t);
